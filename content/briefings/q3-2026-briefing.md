---
title: "Everyone Is Watching the Wrong Screen"
subtitle: "The Q3 2026 Quarterly Briefing"
date: "2026-07-01"
...
<figcaption>The board has multiple paths forward. The question is which prices resolve first.</figcaption>

<figure>
<svg viewBox="0 0 1440 920" xmlns="http://www.w3.org/2000/svg" font-family="'Segoe UI', system-ui, -apple-system, sans-serif">
  <defs>
    <linearGradient id="bg1" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#0b0f0d"/>
      <stop offset="1" stop-color="#070a08"/>
    </linearGradient>
    <linearGradient id="mktfill1" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#35c07d" stop-opacity="0.22"/>
      <stop offset="1" stop-color="#35c07d" stop-opacity="0"/>
    </linearGradient>
  </defs>

  <rect width="1440" height="920" fill="url(#bg1)"/>

  <text x="70" y="66" fill="#e8ede9" font-size="30" font-weight="600">Price moves before policy confirms it</text>
  <text x="70" y="98" fill="#8b9490" font-size="17">Market-implied December hike probability against the official communication record, January to June 2026.</text>
  ...
  <g stroke="#141a16" stroke-dasharray="3 5" stroke-width="1">
    <line x1="150" y1="180" x2="1230" y2="180"/>
    <line x1="150" y1="290" x2="1230" y2="290"/>
    <line x1="150" y1="400" x2="1230" y2="400"/>
  </g>
  <text x="58" y="290" fill="#7c857f" font-size="13" text-anchor="middle" transform="rotate(-90 58 290)">DEC HIKE ODDS, MARKET-IMPLIED</text>

  <path d="M150,345 L366,345 L582,331 L798,312 L1014,275 L1230,235 L1230,400 L150,400 Z" fill="url(#mktfill1)"/>
  ...
  <text x="1230" y="222" fill="#5ad89b" font-size="14" text-anchor="middle" font-family="'Consolas','SF Mono',monospace" font-weight="600">~75%</text>

  <rect x="582" y="150" width="648" height="470" fill="#35c07d" opacity="0.035"/>
  <text x="592" y="172" fill="#5ad89b" font-size="13" font-style="italic">the odds catch up late, but the shift was legible earlier</text>

  <line x1="150" y1="700" x2="1230" y2="700" stroke="#2b332e" stroke-width="2"/>
  <text x="70" y="705" fill="#8b9490" font-size="13" font-weight="600">OFFICIAL</text>
  <text x="70" y="722" fill="#8b9490" font-size="13" font-weight="600">RECORD</text>

  <g stroke="#39423c" stroke-width="1.5" stroke-dasharray="2 4">
  ...
  <text x="94" y="778" fill="#cdd5cf" font-size="14">Consensus path: two cuts</text>
  <text x="94" y="800" fill="#cdd5cf" font-size="14">priced for the year.</text>
  ...
  <text x="484" y="778" fill="#cdd5cf" font-size="14">Dealer survey median still shows</text>
  <text x="484" y="798" fill="#cdd5cf" font-size="14">two cuts, but the Desk notes</text>
  <text x="484" y="818" fill="#cdd5cf" font-size="14">respondents had already shifted</text>
  <text x="484" y="838" fill="#cdd5cf" font-size="14">to fewer cuts <tspan fill="#5ad89b">after submitting.</tspan></text>
  <text x="484" y="862" fill="#8b9490" font-size="12.5" font-style="italic">The record lags the dealer on arrival.</text>
  ...
  <text x="700" y="778" fill="#cdd5cf" font-size="14">Vote splits 8 to 4, pulled apart</text>
  <text x="700" y="798" fill="#cdd5cf" font-size="14">from both flanks at once.</text>
  <text x="700" y="822" fill="#e05a4f" font-size="13.5" font-weight="600">First 4-dissent action in 30+ yrs.</text>
  ...
  <text x="1132" y="778" fill="#cdd5cf" font-size="14">Dot median 3.4% to 3.8%.</text>
  <text x="1132" y="798" fill="#cdd5cf" font-size="14">9 of 18 pencil in a hike.</text>
  <text x="1132" y="822" fill="#cdd5cf" font-size="14">Unanimous 12 to 0. The change,</text>
  <text x="1132" y="842" fill="#cdd5cf" font-size="14">finally, made explicit.</text>

  <line x1="70" y1="890" x2="1370" y2="890" stroke="#1e2622" stroke-width="1"/>
  <text x="70" y="912" fill="#8b9490" font-size="14"><tspan fill="#e8ede9" font-weight="600">Read:</tspan> June announced a shift already visible in the record since March. The longer-run anchor held at 3.1% in both the March and June projections, two regimes quoted in one document.</text>
</svg>
<figcaption>Market-implied probability of a December 2026 hike moved from 25% in January to 75% by June, but the repricing concentrated in March and April, before the Fed's formal announcement.</figcaption>
</figure>
...
<svg viewBox="0 0 1440 920" xmlns="http://www.w3.org/2000/svg" font-family="'Segoe UI', system-ui, -apple-system, sans-serif">
  <defs>
    ...
    <linearGradient id="barfill2" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#35c07d"/>
      <stop offset="1" stop-color="#1f6b48"/>
    </linearGradient>
    <marker id="arrow2" markerWidth="10" markerHeight="10" refX="6" refY="3" orient="auto">
      <path d="M0,0 L6,3 L0,6 Z" fill="#e05a4f"/>
    </marker>
  </defs>

  <rect width="1440" height="920" fill="url(#bg2)"/>

  <text x="70" y="66" fill="#e8ede9" font-size="30" font-weight="600">A physical engine, financed at the long end</text>
  <text x="70" y="98" fill="#8b9490" font-size="17">Top-five hyperscaler capital expenditure, and the market that has to clear its financing. Two systems, one link.</text>
  <line x1="70" y1="116" x2="1370" y2="116" stroke="#1e2622" stroke-width="1"/>
  ...
  <text x="60" y="440" fill="#7c857f" font-size="13" text-anchor="middle" transform="rotate(-90 60 440)">HYPERSCALER CAPEX, TOP 5</text>

  <rect x="230" y="522" width="130" height="178" fill="#1e5c40"/>
  <rect x="500" y="393" width="130" height="307" fill="#24734e"/>
  <rect x="770" y="249" width="130" height="451" fill="url(#barfill2)"/>
  <rect x="770" y="215" width="130" height="34" fill="#35c07d" opacity="0.25"/>
  <line x1="770" y1="215" x2="900" y2="215" stroke="#5ad89b" stroke-width="2" stroke-dasharray="4 4"/>
  <text x="835" y="207" fill="#5ad89b" font-size="12" text-anchor="middle" font-family="'Consolas','SF Mono',monospace">to 700</text>

  <g fill="#e8ede9" font-size="17" text-anchor="middle" font-weight="600" font-family="'Consolas','SF Mono',monospace">
  ...
  <path d="M905,262 C 965,262 985,300 1008,320" fill="none" stroke="#e05a4f" stroke-width="2.5" marker-end="url(#arrow2)" opacity="0.9"/>
  <text x="912" y="250" fill="#c96a63" font-size="12.5" font-family="'Consolas','SF Mono',monospace">must clear</text>

  <text x="150" y="762" fill="#7c857f" font-size="13" font-style="italic">Bars: reported top-five hyperscaler guidance. The financing side is stated as levels, not plotted as a derived line.</text>

  <rect x="1010" y="150" width="360" height="560" rx="8" fill="#101613" stroke="#1e2622"/>
  <text x="1032" y="184" fill="#e8ede9" font-size="17" font-weight="600">What the engine runs on</text>
  ...
  <text x="1032" y="262" fill="#cdd5cf" font-size="14">capex growth in two years,</text>
  <text x="1032" y="282" fill="#cdd5cf" font-size="14">$256B to $650 or 700B.</text>
  ...
  <text x="1032" y="370" fill="#cdd5cf" font-size="14">capital intensity as a share of</text>
  <text x="1032" y="390" fill="#cdd5cf" font-size="14">revenue, no recent precedent.</text>
  ...
  <text x="1032" y="478" fill="#cdd5cf" font-size="14">gross investment-grade issuance</text>
  <text x="1032" y="498" fill="#cdd5cf" font-size="14">this year, up about 25% on the year.</text>

  <line x1="1032" y1="522" x2="1348" y2="522" stroke="#171d19"/>

  <text x="1032" y="560" fill="#e05a4f" font-size="15" font-weight="600">The uncoupling ends here.</text>
  <text x="1032" y="586" fill="#aab3ad" font-size="14">The buildout is substantially</text>
  <text x="1032" y="606" fill="#aab3ad" font-size="14">debt-financed, underwritten in part</text>
  <text x="1032" y="626" fill="#aab3ad" font-size="14">against the value of the equity the</text>
  <text x="1032" y="646" fill="#aab3ad" font-size="14">debt is helping to inflate.</text>
  <text x="1032" y="678" fill="#e8ede9" font-size="14">A multi-decade physical liability,</text>
  <text x="1032" y="698" fill="#e8ede9" font-size="14">priced at the long end, not the funds rate.</text>

  <line x1="70" y1="880" x2="1370" y2="880" stroke="#1e2622" stroke-width="1"/>
  <text x="70" y="906" fill="#8b9490" font-size="14"><tspan fill="#e8ede9" font-weight="600">Read:</tspan> The rally is not running on easier policy. It runs on a physical-constraint spending cycle whose scale must clear the long-duration credit market. The open question is whether that market absorbs the financing without demanding materially more.</text>
</svg>
<figcaption>Top-five hyperscaler capex accelerating 2.5x across three years, now facing record investment-grade issuance. The uncoupling between equities (capex-driven) and policy (tightening) ends where this debt gets financed: the long end of the curve.</figcaption>
</figure>
...
<figcaption>Dollar Index and COT positioning structure, showing speculative crowding at trailing-year extremes and participation momentum into the July close.</figcaption>
...
<figcaption>30-Year Treasury futures and COT positioning, showing speculative crowding at the short extreme with dealer absorption on the other side and rising open interest into the close.</figcaption>
